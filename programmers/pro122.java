...
public class pro122 {
    ...
    public static void main(String[] args) {
        ...
        String answer = pages[0];
        String test1 = answer.replaceAll("[^a-zA-Z]"," ");
        String test2 = answer.replaceAll("[^a-z^A-Z]"," ");
        String test3 = answer.replaceAll("[^a-z_^A-Z]"," ");
